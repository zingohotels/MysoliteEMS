...
public class LocaitionPassWithConditionServices extends Service {
    ...
    public LocaitionPassWithConditionServices() {
    }
    ...
    private void startForegroundService()
    {
       ...
       /* Bitmap largeIconBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.app_logo);
        ...
        Intent playIntent = new Intent(this, LocaitionPassWithConditionServices.class);
        ...
        Intent pauseIntent = new Intent(this, LocaitionPassWithConditionServices.class);
