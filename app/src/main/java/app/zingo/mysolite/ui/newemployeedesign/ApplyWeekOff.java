...
public class ApplyWeekOff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            setContentView(R.layout.activity_apply_week_off);
    ...
    public void validate(){
        ...
        /*if(leaveType.isEmpty()){
            ...
            Toast.makeText(this, "Week-Off Comment is required", Toast.LENGTH_SHORT).show();
            ...
            try{
                ...
                leaves.setApproverComment("WeekOff");
                ...
                if(employeeId!=0){
                    ...
                    leaves.setEmployeeId(PreferenceHandler.getInstance( ApplyWeekOff.this).getUserId());
                }
                    ...
                    if (statusCode == 200 || statusCode == 201) {
                        ...
                        if(s!=null){
                            ...
                            if(managerId!=0){
                                ...
                                lm.setEmployeeId(PreferenceHandler.getInstance( ApplyWeekOff.this).getManagerId());
                            }
                            lm.setManagerId(s.getEmployeeId());
                            lm.setEmployeeName(PreferenceHandler.getInstance( ApplyWeekOff.this).getUserFullName());
                        ...
                        Toast.makeText( ApplyWeekOff.this, "Failed Due to "+response.message(), Toast.LENGTH_SHORT).show();
                    }
                }
                catch (Exception ex)
                {
