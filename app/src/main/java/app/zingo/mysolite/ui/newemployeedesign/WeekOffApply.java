...
public class WeekOffApply extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            setContentView(R.layout.activity_week_off_apply);
            ...
            /*9C9C9C*/
            labelNew.setText("Apply Week-Off");
            tabText.setIndicator(tabNew);
            Intent dash = new Intent(this, ApplyWeekOff.class);
            dash.putExtra("EmployeeId", employeeId);
            tabText.setContent(dash);

            labelRequest.setText("Week-Off");
            tabMaps.setIndicator(tabRequest);
            Intent maps = new Intent(this, WeekOffDashBoard.class);
