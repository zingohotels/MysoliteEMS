...
public class GooglePlaceMapActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnectionSuspended(int i) {
        ...
        Toast.makeText( GooglePlaceMapActivity.this, "Coonection Suspended", Toast.LENGTH_SHORT).show();
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Toast.makeText( GooglePlaceMapActivity.this, "Connection Failed", Toast.LENGTH_SHORT).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder( GooglePlaceMapActivity.this)
                .setMessage(message)
