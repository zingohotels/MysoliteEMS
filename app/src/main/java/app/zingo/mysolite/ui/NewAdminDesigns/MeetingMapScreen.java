...
public class MeetingMapScreen extends AppCompatActivity {
    ...
    MeetingDetailsNotificationManagers ln;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if(bundle!=null){
                ...
                ln = (MeetingDetailsNotificationManagers)bundle.getSerializable("Location");
            }

            try {
                MapsInitializer.initialize( MeetingMapScreen.this);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
                        ...
                        if(ln!=null){
                            ...
                            if(markerData!=null&&markerData.size()!=0){
                                ...
                                if (MarkerPoints.size() > 2) {
                                    ...
                                    MeetingMapScreen.FetchUrl FetchUrl = new MeetingMapScreen.FetchUrl();
    ...
    private class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            MeetingMapScreen.ParserTask parserTask = new MeetingMapScreen.ParserTask();
