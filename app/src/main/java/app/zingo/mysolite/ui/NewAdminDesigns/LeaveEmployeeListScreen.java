...
import app.zingo.mysolite.adapter.LeaveTakenEmployeeAdapter;
...
public class LeaveEmployeeListScreen extends AppCompatActivity {
                ...
                call.enqueue(new Callback<ArrayList<Leaves>>() {
                    ...
                    public void onResponse(Call<ArrayList<Leaves>> call, Response<ArrayList<Leaves>> response) {
                        ...
                        if (statusCode == 200 || statusCode == 201 || statusCode == 203 || statusCode == 204) {
                            ...
                            Toast.makeText( LeaveEmployeeListScreen.this, "Failed due to : "+response.message(), Toast.LENGTH_SHORT).show();
                        }
                    }
