...
public class OrderListAdapter extends RecyclerView.Adapter< OrderListAdapter.ViewHolder>{
    ...
    public OrderListAdapter(Context context, ArrayList<Tasks> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(dto!=null){
            ...
            holder.mPaymentDate.setText(tos);
            if(dto.getPriority()!=null){

                holder.mOrderAmount.setText("₹ "+dto.getPriority());
            ...
            if(status.equalsIgnoreCase("Pending")){
                ...
                holder.mStatusText.setText("De");
            }else if(status.equalsIgnoreCase("Order Taken")){
                holder.mStatus.setBackgroundColor(Color.parseColor("#FFFF00"));
                holder.mStatusText.setText("OT");
            ...
            holder.mtaskUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent updateSc = new Intent(context, UpdateOrderScreen.class);
    ...
    class ViewHolder extends RecyclerView.ViewHolder /*implements View.OnClickListener*/ {
        ...
        MyRegulerText mToAllocate,mTaskName,mDuration,mCreatedBy,mOrderAmount,mPaymentDate;
        View mStatus;
        ...
        public ViewHolder(View itemView) {
            ...
            mPaymentDate = itemView.findViewById(R.id.time_task_payment);
            mOrderAmount = itemView.findViewById(R.id.order_amount);
