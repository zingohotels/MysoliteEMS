...
public class  TaskAdminListAdapter extends RecyclerView.Adapter< TaskAdminListAdapter.ViewHolder>{
    ...
    public TaskAdminListAdapter(Context context, ArrayList< TaskAdminData > list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(dto!=null){
            ...
            String status = dto.getTasks().getStatus();


            holder.mTaskName.setText(dto.getTasks().getTaskName());
            // holder.mTaskDesc.setText("Description: \n"+dto.getTaskDescription());

            String froms = dto.getTasks().getStartDate();
            String tos = dto.getTasks().getEndDate();
            ...
            String lngi = dto.getTasks().getLongitude();
            String lati = dto.getTasks().getLatitude();
            ...
            holder.mToAllocate.setText("To "+dto.getEmployee().getEmployeeName());
            getManagers(dto.getTasks().getToReportEmployeeId(),holder.mCreatedBy,"Manager");
